...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HyperLink ID="productoDestacado3" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado4" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado5" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado6" runat="server"><div class = "imgportada">
   ...
   <asp:HyperLink ID="productoDestacado7" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado8" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado9" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado10" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado11" runat="server"><div class = "imgportada">
    ...
    <asp:HyperLink ID="productoDestacado12" runat="server"><div class = "imgportada">
